...
public class PreviewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void showButtonPanel(boolean show) {
        if (show) {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.confirm_media_result) {
            ...
            deleteMediaFile();
            resultIntent.putExtra(RESPONSE_CODE_ARG, BaseAwesomeCamActivity.ACTION_CANCEL);
        }
    ...
    public static boolean isResultConfirm(@NonNull Intent resultIntent) {
        return BaseAwesomeCamActivity.ACTION_CONFIRM == resultIntent.getIntExtra(RESPONSE_CODE_ARG, -1);
    }
    ...
    public static boolean isResultRetake(@NonNull Intent resultIntent) {
        return BaseAwesomeCamActivity.ACTION_RETAKE == resultIntent.getIntExtra(RESPONSE_CODE_ARG, -1);
    }

    public static boolean isResultCancel(@NonNull Intent resultIntent) {
        return BaseAwesomeCamActivity.ACTION_CANCEL == resultIntent.getIntExtra(RESPONSE_CODE_ARG, -1);
    }
