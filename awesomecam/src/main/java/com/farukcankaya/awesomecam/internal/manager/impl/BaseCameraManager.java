...
abstract class BaseCameraManager<CameraId, SurfaceListener, CameraParameters, Camera>
        implements com.farukcankaya.awesomecam.internal.manager.CameraManager<CameraId, SurfaceListener, CameraParameters, Camera>, MediaRecorder.OnInfoListener {
    ...
    protected abstract int getPhotoOrientation(@AwesomeCamConfiguration.SensorPosition int sensorPosition);

    protected abstract int getVideoOrientation(@AwesomeCamConfiguration.SensorPosition int sensorPosition);
